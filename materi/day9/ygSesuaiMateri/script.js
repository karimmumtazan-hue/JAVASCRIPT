...
if (students.length === 0) {
  studentList.innerHTML = '<div class="empty">📭 Belum ada data siswa.</div>';
    ...
    // <div class="student-item"><div class="student-name"><span class="student-number">1.</span>undefined</div><div class="score">90</div><div class="action-buttons"><button class="edit-btn" type="button">✏️ Ubah</button><button class="delete-btn" type="button">🗑️ Hapus</button></div></div>
}
